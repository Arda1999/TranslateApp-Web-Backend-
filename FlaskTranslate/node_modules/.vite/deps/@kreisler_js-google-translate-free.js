...
// node_modules/@kreisler/js-google-translate-free/dist/index.esm.js
var FROM_DEFAULT_LANG = "auto";
var ALL_LANGUAJES = {
  auto: "auto",
  af: "af",
  sq: "sq",
...
var _JsGoogleTranslateFree_static, requestTranslation_fn, getSentencesFromJSON_fn;
var _JsGoogleTranslateFree = class _JsGoogleTranslateFree {
  /**
  ...
  static async translate(options) {
    ...
    const response = await __privateMethod(_a = _JsGoogleTranslateFree, _JsGoogleTranslateFree_static, requestTranslation_fn).call(_a, source, to, text);
    const translation = __privateMethod(_b = _JsGoogleTranslateFree, _JsGoogleTranslateFree_static, getSentencesFromJSON_fn).call(_b, response);
    return translation;
  }
};
_JsGoogleTranslateFree_static = new WeakSet();
requestTranslation_fn = async function(source, target, text) {
  if (text.length >= 5e3) {
  ...
  try {
    const response = await axios_default.get(url + formData, {
...
getSentencesFromJSON_fn = function(json) {
...
__privateAdd(_JsGoogleTranslateFree, _JsGoogleTranslateFree_static);
var JsGoogleTranslateFree = _JsGoogleTranslateFree;
var ErrorStringToJsGoogleTranslateFree = class extends Error {
  constructor(message) {
    super(message);
    this.name = "ErrorStringToJsGoogleTranslateFree";
  }
};
var ErrorStringTextJsGoogleTranslateFree = class extends Error {
  constructor(message) {
    super(message);
...
export {
  ...
  JsGoogleTranslateFree as default
};
/*! Bundled license information:

@kreisler/js-google-translate-free/dist/index.esm.js:
  (*!
   ...
   *)
*/
//# sourceMappingURL=@kreisler_js-google-translate-free.js.map
